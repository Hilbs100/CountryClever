...
public class DoTheStuff {
    public static void run() {
        ...
        Africa.addCountry("Western Sahara");
        ...
        Country netherlands = new Country(16040, "Despite a common misconception, Holland is actually part of the Netherlands.", "The Netherlands", 17280000, "Amsterdam", "Dutch",
